...
try {   
    ...
    if(isset($_GET['search'])) {
        ...
        // If no search term provided, display all paintings
...
<div class="container-fluid" style="padding-top: 80px; padding-left: 15px; padding-right: 15px; padding-bottom: 50px">  
    ...
    <table class="table table-striped" style="width: 80%; margin: 0 auto">
        ...
        <tbody>
            <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
                <tr>
                    <td><img src="data:image/jpeg;base64,<?php echo base64_encode($row['Image']); ?>" alt="Painting Image"/></td>
    ...
    <?php else: ?>
    <div style="text-align: center; margin-top: 20px;">No paintings found</div>
    <?php endif; ?>
</div>
