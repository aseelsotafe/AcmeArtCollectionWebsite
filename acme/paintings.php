...
try {
    $sql = "SELECT p.*, a.Name AS Artist, s.Name AS Style FROM Paintings p
...
<!-- Main container with painting details -->
<div class="container-fluid" style="padding-top: 80px; padding-left: 15px; padding-right: 15px; padding-bottom: 50px">
        ...
        <tr>
            <th style="width: 5%;">
                <div style="position: relative; top: -10px;">
                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal">Add New Painting</button>
                </div>
            </th>
            <th style="width: 17%">Painting Title</th>
            <th style="width: 5%">Finished</th>
            <th style="width: 6%">Media</th>
            <th style="width: 12%">Artist's Name</th>
    ...
    <tbody>
        ...
        <tr>
            <td><img src="data:image/gif;base64,<?php echo base64_encode($row['Thumbnail']); ?>" /></td>
