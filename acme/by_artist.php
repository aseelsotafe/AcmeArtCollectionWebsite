...
// Fetch paintings by artist
$stmt = $pdo->prepare("SELECT * FROM Paintings WHERE ArtistID = ?");
...
<html>
<head>
    <title>Paintings Gallery - By Artist</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container">
        <h1 class="mt-5 mb-4">Paintings Gallery - By Artist</h1>
